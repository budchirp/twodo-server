...
export class EnvValidator {
  ...
  private static readInteger(config: Environment, key: string, defaultValue: number) {
  ...
  private static readString(config: Environment, key: string, defaultValue: string) {
